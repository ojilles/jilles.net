...
task :tidy_html do
    ...
    sh "find ./_site/perma -type f \\( -name '*.xml' -o -name '*.html' \\)    -exec sh -c '(echo {}; tidy -quiet -indent -modify -wrap 159 {}) &>.tidy_log_tmp; cat .tidy_log_tmp >> .tidy_log' \\;"
    sh "find ./_site -depth 1 -type f \\( -name '*.xml' -o -name '*.html' \\) -exec sh -c '(echo {}; tidy -quiet -indent -modify -wrap 159 {}) &>.tidy_log_tmp; cat .tidy_log_tmp >> .tidy_log' \\;"
    sh "rm .tidy_log_tmp"
end
